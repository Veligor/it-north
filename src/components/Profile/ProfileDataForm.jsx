  ...
  return <div>
    ...
    <Formik
      ...
      <div> <b>FullName: </b>   <Field type="text" name="FullName" placeholder="Full name" className={s.fullName}/></div>
        <div className={s.fieldSlaider}> <label className={s.checkBox} for='checkBox'><Field type="checkbox" name="lookingForAJob" className={s.checkBoxInput} id='checkBox'/><span className={s.checkboxInner}><b>Looking for a job </b></span></label> </div>
